...
/*  		
    ...
    $.ajax({                         //의뢰 리스트 ajax로 불러오는부분
			url:"/MemberMissionSearchList",
			type:"post",
						//contentType: "application/json; charset=UTF-8", 
						data:"searchDay="+$("#searchDay").val(), //empno=7733  
						success:function(res){
								console.log(res);	//"[{"empno
								var reshtml ="<table class='table'>";
			  					reshtml+="<thead>";
			  					reshtml+="<tr><th>날짜</th><th>상세내역</th><th>최종금액</th><th>주문상태</th><th>의뢰자</th></tr>";
			  					reshtml+="</thead>";
  ...
  */ 			
  ...
  <body>
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">의뢰내역 / 수주내역</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">Check Order - Check Mission</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div id="customer-account" class="col-lg-9 clearfix">
             <div class="container">
              ...
              <thead></thead>
               <tbody>
	              <tr>
	              	<td colspan="2"><font size="5">안녕하세요
	              	<font color="#7700"> 김철희님</font></font></td>
	              	<td></td>
				  </tr>  
				  <tr> 
				  	<td colspan ="3">
				  	   <section class="bar bg-white no-mb">
          <div class="container">
            <div class="row showcase text-center">
              <div class="col-md-3 col-sm-6">
                <div class="item">
                  <div class="icon-outlined icon-sm icon-thin"><i class="fa fa-align-justify"></i></div>
                  <h4><span class="h1 counter">4</span><br> 의뢰요청</h4>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
                <div class="item">
                  <div class="icon-outlined icon-sm icon-thin"><i class="fa fa-users"></i></div>
                  <h4><span class="h1 counter">3</span><br>의뢰수주</h4>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
                <div class="item">
                  <div class="icon-outlined icon-sm icon-thin"><i class="fa fa-copy"></i></div>
                  <h4><span class="h1 counter">23,320</span><br>포인트</h4>
                </div>
              </div>
            ...
            <div class="content">
                ...
                <div class="panel-body">
                    ...
                    <div class="input-group">
                      <input name = "searchDay" type="text" placeholder=" 예) 7일이내면 '7'입력" class=""><span class="input-group-btn">
                        <button value="1" name="lmk" class="btn btn-template-main"><i class="fa fa-search"></i></button></span>
                    </div>
               ...
               <br>
                ...
                <div class="content">
                  <div class="table-responsive">
                    <div class="heading">
                 		 <h3 class="text-uppercase">의뢰 요청 내역</h3>
             	    </div>
                ...
                <div class="content">
                  <div class="table-responsive">
                   <div class="heading">
                  <h3 class="text-uppercase">의뢰 수주 내역</h3>
                </div>
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="customer-orders.html" class="nav-link active"><i class="fa fa-list"></i>의뢰신청 / 수주</a></li>
    ...
    <!------------  <li class="nav-item"><a href="index.html" class="nav-link"><i class="fa fa-sign-out"></i> Logout</a></li>---------------------로그아웃 -->  
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="customer-account.jsp" class="nav-link "><i class="fa fa-list"></i>기본정보 변경</a></li>
