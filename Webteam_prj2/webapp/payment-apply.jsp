                ...
                <form>
                  <div class="row">
                   ...
                   <div class="row">
                  	<div class="col-md-6">
                      <div class="form-group">
                        <label for="firstname"><font color="red"><h4> 출금 포인트 </h4></font></label>
                        <input id="paymentPoint" name = "paymentPoint" type="text" class="form-control" value="100">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12 text-center">
                      <button type="submit" id = "paymentBtn" class="btn btn-template-outlined"><i class="fa fa-envelope-o"></i> 신   청   </button>
                    </div>
                    <p class="lead"></p>
                    <!-- 잔액이 부족합니다. -->
                    <div role="alert" id="money" class="alert alert-danger">잔액이 부족합니다.</div>
                </form>
              </section>
            </div>
