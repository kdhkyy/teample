...
$(document).ready(function(){
	$("#mPimg").on("change", myFilePreviewFunc);
        ...
        <div class="container">
          <div class="row bar">
            <div id="customer-account" class="col-lg-9 clearfix">
              <p class="lead">회원가입을 하실 수 있습니다.</p>
              <p class="text-muted">동일한 이메일로 자체가입 혹은 다른 포털아이디로 가입은 가능하지만 포인트등의 정보공유는 되지않습니다.</p>
              <div class="box mt-5">
               
             
                <div class="heading">
                  <h3 class="text-uppercase">회원정보 입력</h3>
                </div>
               ...
               <!---------------------- 회원가입 폼 시작 -------------------------------------->
                ...
                <form id="regForm" action="/MemberRegister" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="mEmail" id="mEmail" type="text" class="form-control">
                      </div>
                    </div>
                   ...
                   <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input name="mPw" id="mPw" type="password" class="form-control">
                      </div>
                  </div>
                       <div class="col-md-4">
                      <div class="form-group">
                        <label for="mPw2">비밀번호 확인</label>
                        <input name="mPw2" id="mPw2" type="password" class="form-control">
                      </div>
                    </div>
                   </div>
                  ...
                  <div class="row">		 
                     <div class="col-md-6">
                      <div class="form-group">   
                            <label for="mPimg">프로필 업로드</label>
		                    <input id="mPimg" type="file" value="프로필 업로드" name="mPimg"> <!--  multiple -->
		                    <div class="form-group">
		                    		<font color="red" size="1" >*사진등록은 필수입니다.</font>
		                    </div>
		                  </div>
		                  </div>
                    </div>  
                  ...
                  <div class="row">
                   <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="mPhone" id="mPhone" type="text" class="form-control">
                        <h6>예) 01040007203 </h6>
                 ...
                 <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="mZipcode">우편주소</label>
                        <input name="mZipcode" id="mZipcode" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="lastname"><br></label>
                     <input class="form-control" type="button" id="zipcodeBtn" onclick="searchAddress()" 
                     value="우편번호 찾기"><br>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-5">
                     <div class="form-group">
                        <label for="mAddress">도로명주소 <font size="1" color="red">*배송지 주소로 사용됩니다.</font></label>
                        <input name="mAddress" id="mAddress" type="text" class="form-control">
                      </div>
                     </div>
                     <div class="col-lg-5">
                     	<div class="form-group">
                        <label for="mAddressJibun">지번주소</label>
                        <input name="mAddressJibun" id="mAddressJibun" type="text" class="form-control">
                        </div>
                     </div>   
                     <div class="col-lg-6">
                     <div class="form-group">
                      <label for="mAddressDetail">상세주소</label>
                        <input name="mAddressDetail" id="mAddressDetail" type="text" class="form-control">
                        </div>
                     </div>
                  ...
                  <div class="row">
                   <div class="col-md-3">
                   	<div class="form-group">
                   		<label for="mBank">은행</label>
                        <input id="mBank" name="mBank" type="text" class="form-control">
                   	</div>
                   </div>
                 
                   <div class="col-md-6">
                      <div class="form-group">
                        <label for="mAccountNumber">계좌</label>
                        <input id="mAccountNumber" name="mAccountNumber" type="text" class="form-control">
                    ...
                    <div class="col-md-12 text-center">
                      <label for="mPush"><br><br>이벤트 정보 메일 수신 동의여부<br><br> </label>
                      
                    </div>
                    <div class="col-md-12 text-center">
                      <input type="radio" name="mPush" id="mPush" value="y">&nbsp&nbsp예, 받겠습니다. &nbsp&nbsp&nbsp&nbsp
                      <input type="radio" name="mPush" id="mPush" value="n">&nbsp&nbsp아니요, 받지 않겠습니다.  
                      <br>   <br><br>               			
                    </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 text-center">
                    <input type="hidden" name="mFrom" id="mFrom" value="우리회사" >
                    <input type="hidden" name="mDeleteYn" id="mDeleteYn" value="n">
                      <button id="regBtn" name="regBtn" class="btn btn-template-outlined"><i class="fa fa-save"></i>회원가입</button>
                      <button type="submit" class="btn btn-template-outlined"><a href="index3.jsp"><i class="fa fa-save"></i>취소</a></button>
                    </div>
                    </div>
...
function searchAddress() {
    new daum.Postcode({
        oncomplete: function(data) {
            ...
            document.getElementById("mAddress").value = roadAddr;
            document.getElementById("mAddressJibun").value = data.jibunAddress;
