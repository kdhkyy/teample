        ...
        <div class="container">
          <div class="row bar">
            ...
            <div id="blog-post" class="col-md-12">
               ...
               <form method="POST" action="questionUpdateServlet" id="questionForm"class="questionForm" name="questionForm" >
                  <div class="row">
                    <div class="col-sm-6">
    			...
    			<input type="hidden"  name="qSeq" id="qSeq" value='${RES_VO.qSeq}'>
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <textarea name="qText" id="comment" rows="16" class="form-control">${RES_VO.qText}</textarea>
                      </div>
                    </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12 text-right">
                      <button class="btn btn-template-outlined" name="regBtn"><i class="fa fa-comment-o"></i>수정확인</button>
                    </div>
                  </div>
                  </form>
                  </div>
