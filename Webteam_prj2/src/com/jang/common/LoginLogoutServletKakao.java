 ...
 */
@WebServlet("/LoginLogoutServletKakao")
public class LoginLogoutServletKakao extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoginLogoutServletKakao() {
        super();
...
MemberVO uvo = dao.selectKakao(vo);
